...
function CreditCardContent(){
    ...
    const fetchTransaction = async() => {
        ...
        try {
            const response = await axios.get(`${ApiUrl.transaction_getCardPayment}/${currentPage}`);
    ...
    return(
        <>
            ...
            <Pagination apiRoute={ApiUrl.transaction_getCardPayment} currentPage={currentPage} setCurrentPage={setCurrentPage}/>
            </TitleCard>
        </>
    )
}
