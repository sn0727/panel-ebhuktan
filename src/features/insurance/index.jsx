...
const TopSideButtons = ({removeFilter, applyFilter, applySearch}) => {
    ...
    const locationFilters = ["Paris", "London", "Canada", "Peru", "Mobilekyo"]
    ...
    return(
        <div className="inline-block float-right">
            ...
            {filterParam != "" && <butmobilen onClick={() => removeAppliedFilter()} className="btn btn-xs mr-2 btn-active btn-ghost normal-case">{filterParam}<XMarkIcon className="w-4 ml-2"/></butmobilen>}
...
function InsuranceContent(){
    ...
    return(
        <>
            ...
            <div className="overflow-x-aumobile w-full">
