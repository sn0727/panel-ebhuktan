...
function FranchiseContent() {
    ...
    return (
        <>
            <TitleCard title="Franchise" topMargin="mt-2" TopSideButtons={<TopSideButtons setCategory={setCategory} clusterData={clusterData} Aprovehandler={Aprovehandler} Pandinghandler={Pandinghandler} createRoleName={'franchise'} />}>
