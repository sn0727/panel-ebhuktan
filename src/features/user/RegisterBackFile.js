...
function Register({ revicedIdRegister }) {
                    ...
                    <div className='py-10 px-10'>
                        ...
                        <div className="mb-4">
                            <div className='inputRow'>
                                ...
                                <InputText type="number" defaultValue={registerObj.contact} updateType="contact" containerStyle="mt-1" labelTitle="Contact No." updateFormValue={updateFormValue} />
                            </div>
                            <div className='inputRow relative'>
                                {aadharOTP === 'verify' ? <p className='verify'>✅</p> : null}
                                <InputText type="number" defaultValue={registerObj.aadharNo} updateType="aadharNo" containerStyle="mt-1" labelTitle="Aadhaar No." updateFormValue={updateFormValue} />
                            ...
                            <div className='inputRow'>
                                {aadharOTP === 'show' ? <InputText type="number"
                                    ...
                                    containerStyle="mt-1" labelTitle="Aadhaar OTP"
                            ...
                            <div className='inputRow'>
                                {role !== 'cluster' ?
                                    <InputText type="number" defaultValue={registerObj.adminId} updateType="adminId" containerStyle="mt-1" labelTitle={role === 'distributor' ? "Cluster Id" : role === 'retailer' || role === 'franchise' ? 'Distributor' : 'Referral Id'} updateFormValue={updateFormValue} />
                                    : null}
                            ...
                            <div className='inputRow'>
                                ...
                                <InputText defaultValue={registerObj.password} type="password" updateType="password" containerStyle="mt-1" labelTitle="Password" updateFormValue={updateFormValue} />
                            </div>
                        ...
                        <Stack direction='colunm' align='center' spacing={4}>
                            ...
                            <Button colorScheme='blue' spacing={2} onClick={()=> submitForm()}>Submit</Button>
                        </Stack>
