function DashboardStatsTwo({title, icon, value, description, colorIndex}){
    ...
    return(
        <div className="stats shadow">
            <div className="stat">
                ...
                <div className={`stat-value dark:text-slate-300 text-${COLORS[colorIndex%2]}`}> {icon} {value}</div>
