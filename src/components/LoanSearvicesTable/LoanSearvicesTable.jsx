...
function LoanSearvicesTable({
    getFilterLoanServices,
    pagetableName,
    getPageLimit,
    createRoleName,
    requestPageName
    ...
    console.log('getFilterLoanServices', getFilterLoanServices)
                        ...
                        <table className="table w-full">
                            <thead>
                                <tr>
                                    ...
                                    <td className="text-left">Business Type</td>
                                    <td className="text-left">Occupation</td>
                                        ...
                                        return (
                                            <tr key={k}>
                                                <>
                                                        ...
                                                        <div className="badge badge-primary">
                                                            ...
                                                            }
                                                            {
                                                                ...
                                                                <ChangeStatusFinnanceServicesTable
                                                                    ...
                                                                    status={l?.Status}
                                                                    filterTransaction={filterTransaction}
                                                                    changeStatusApi={ApiUrl?.loanChangeStatus}
                                                                />
                                                            }
                                                        </div>
                                                    </td>}
                                                    ...
                                                    <td className="text-right">{moment(l.modifiedCreatedAt).format('DD/MMM/yyyy, hh:mm A') ? moment(l.CreatedAt).format('DD/MMM/yyyy, hh:mm:ss A') : 'not available'}</td>
                                                </>
                                            </tr>
                                        )
                                    })
...
export default LoanSearvicesTable