...
export default function ChangeStatusFinnanceServicesTable({ id = null, status, filterTransaction, useDetails, changeStatusApi }) {
    ...
    const updateFormValue = ({ updateType, value }) => {
        setRemarks({ ...remark, [updateType]: value })
    }
